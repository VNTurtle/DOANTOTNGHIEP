...
$bookTypeIds = DP::run_query($queryBookTypes, $parameters, $ketquaType);

$queryLst_Types = "SELECT * FROM `typedetail` WHERE 1";
$Lst_Type = DP::run_query($queryLst_Types, $parameters, $ketquaType);

$queryCoverType = "SELECT * FROM `covertype` WHERE 1";
$Lst_CoverType = DP::run_query($queryCoverType, $parameters, $ketquaType);

$queryPublisher = "SELECT * FROM `publisher` WHERE 1";
$Lst_Publisher = DP::run_query($queryPublisher, $parameters, $ketquaType);
...
foreach ($bookTypeIds as $bookType) {
    ...
    $Top4typeDetails = DP::run_query($Top4queryTypeDetail, $parameters, $ketquaType);
